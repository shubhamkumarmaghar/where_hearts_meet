class RoutesConst {
  ...
  ///guest view route
  static String guestViewScreen = '/guestViewScreen';

  ///view personal wishes routes
  ...
  static String personalMemoriesScreen = '/personalMemoriesScreen';
  static String personalWishesCoverScreen = '/personalWishesCoverScreen';

  static String eGiftsScreen = '/eGiftsScreen';
  static String wishesScreen = '/wishesScreen';
  static String eventCoverScreen = '/eventCoverScreen';
