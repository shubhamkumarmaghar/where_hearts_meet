...
class CreatePersonalCoverScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CreatePersonalCoverController>(
      builder: (controller) {
        return PopScope(
                ...
                children: [
                  Positioned(
                    ...
                    child: Container(
                      ...
                      decoration: controller.imageFile != null
                          ? BoxDecoration(
                              borderRadius: BorderRadius.circular(30),
                              image: DecorationImage(image: FileImage(controller.imageFile!), fit: BoxFit.fitHeight))
                          : BoxDecoration(
                          ...
                          children: [
                            ...
                            Container(
                                ...
                                child: ClipRRect(
                                    ...
                                    child: cachedImage(imageUrl: controller.eventResponseModel.coverImage ?? ''))),
                            SizedBox(
                              width: screenWidth * 0.02,
                            ),
                            Container(
