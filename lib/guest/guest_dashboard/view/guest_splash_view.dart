...
class GuestCoverScreen extends StatefulWidget {
  ...
  @override
  State<GuestCoverScreen> createState() =>
      _GuestCoverScreenState();
}
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Time left',style: GoogleFonts.montserrat(decoration: TextDecoration.none,
                  color: Colors.white,
                  fontWeight: FontWeight.w500,
                  fontSize: 30)),
              Container(
                ...
                child: Center(
                  child: Text(
                    ...
                    style: GoogleFonts.montserrat(decoration: TextDecoration.none,
                        color: Colors.white,
                        fontWeight: FontWeight.w500,
                        fontSize: 30),
                  ),
        ...
        GestureDetector(
          ...
          child: Align(
            ...
            child: Padding(
              ...
              child: CircleAvatar(child: Icon(Icons.arrow_forward,size: 30,),radius: 25),
